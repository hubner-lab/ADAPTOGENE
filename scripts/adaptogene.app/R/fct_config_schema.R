...
config_schema <- function() {
    ...
    list(
        ...
        s("climate.predictors", "Climate predictors", "association", "Climate",
          "bio_chips", TRUE,
          help = "Click to toggle variables for GEA. Review piemaps in Structure K first to drop collinear or low-variance predictors."),
        # Optional — map
        ...
        s("phenotype_association.traits",           "Phenotype traits",    "phenotype", "Traits",
          "pheno_chips", TRUE,
        ...
        s("phenotype_association.promoter_length",  "Promoter length (bp)","phenotype", "Results",
          "numeric", FALSE,
          min = 0, step = 1000,
