...
config_schema <- function() {
    ...
    list(
        ...
        s("Filter.relatedness", "Max relatedness (pi-hat)", "processing", "Filtering",
          ...
          help = "Optional. Remove related samples with plink IBD pi-hat above this (blank = skip). High-selfing species inflate pi-hat — set from the relatedness histogram in Processing QC, not the standard outbred 0.2 default."),
