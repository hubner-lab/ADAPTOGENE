...
config_schema <- function() {
    ...
    list(
        ...
        s("association.combine_gap",      "Combine gap (bp)",   "association", "Results",
          "numeric", FALSE,
          min = 0, step = 10000,
          help = "Maximum distance between SNPs to be considered as overlapping"),
        s("association.sig_snp_distance", "SNP merge dist (bp)","association", "Results",
          "numeric", FALSE,
          min = 0, step = 10000,
          help = "Distance to merge nearby significant SNPs into a single region"),
        s("association.region_distance",  "Region extent (bp)", "association", "Results",
          "text",    FALSE,
          help = "Extension around significant regions for gene search. Use 'auto' for LD-based.",
          placeholder = "2000000"),
        s("association.top_regions",      "Top regions",        "association", "Results",
          "numeric", FALSE,
          min = 0, step = 1,
          help = "Number of top regions for gene annotation and enrichment (0 = all)"),
        ...
        s("enrichment.top_plot_regions", "Top plot regions",  "association", "Enrichment",
          "numeric", FALSE,
          min = 0, step = 1,
          help = "Regions to generate enrichment plots for (0 = all significant regions)"),
        ...
        s("regionplot.genes", "Genes to label", "association", "Region Plot",
          ...
          placeholder = "all"),
        # Performance
        s("association.scattermore_threshold", "Scattermore threshold", "association", "Performance",
          "numeric", FALSE,
          min = 0, step = 5000,
          help = "Use fast point rendering when total SNP count exceeds this value"),
        ...
        s("phenotype_association.sig_snp_distance", "SNP merge dist (bp)", "phenotype", "Results (overrides GEA)",
          "numeric", FALSE,
          min = 0, step = 10000,
          help = "Override GEA sig_snp_distance for GWAS. Leave blank to inherit."),
        ...
        s("phenotype_association.top_regions",      "Top regions",         "phenotype", "Results (overrides GEA)",
          "numeric", FALSE,
          min = 0,
          help = "Override GEA top_regions for GWAS. Blank = inherit."),
        ...
        s("overlap.top_regions",          "Top regions",         "overlapping", "Region Merging",
          "numeric", FALSE,
          min = 0,
          help = "Top N combined regions for gene annotation (0 = all)"),
