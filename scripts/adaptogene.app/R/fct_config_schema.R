...
config_schema <- function() {
    ...
    list(
        ...
        s("GFF.go_field", "GO field in GFF",  "gea", "Methods",
          ...
          placeholder = "NULL"),
        # Results processing
        s("GEA.region_distance",      "Region distance",        "gea", "Results",
          "text",    FALSE,
          help = "Region merging distance. auto_per_chromosome (default) uses per-chr LD decay; auto_genome_wide uses genome-wide; or enter a fixed bp value.",
          placeholder = "auto_per_chromosome"),
        s("GEA.region_r2_threshold",  "LD r\u00b2 threshold",  "gea", "Results",
          "numeric", FALSE,
          min = 0.05, max = 0.95, step = 0.05,
          help = "r\u00b2 level at which LD is considered background. Hill-Weir curve is inverted at this value to get the merging distance (default: 0.2)."),
        s("GEA.region_ld_decay_group","LD decay group",         "gea", "Results",
          "text",    FALSE,
        ...
        s("GWAS.region_distance",      "Region distance",        "gwas", "Results",
          "text",    FALSE,
          help = "Region merging distance. auto_per_chromosome (default) uses per-chr LD decay; auto_genome_wide uses genome-wide; or enter a fixed bp value.",
          placeholder = "auto_per_chromosome"),
        s("GWAS.region_r2_threshold",  "LD r\u00b2 threshold",  "gwas", "Results",
          "numeric", FALSE,
          min = 0.05, max = 0.95, step = 0.05,
          help = "r\u00b2 level at which LD is considered background. Hill-Weir curve is inverted at this value (default: 0.2)."),
        s("GWAS.region_ld_decay_group","LD decay group",         "gwas", "Results",
          "text",    FALSE,
          help = "Which sample group from the LD decay table to use for distance computation (default: All).",
          placeholder = "All"),
