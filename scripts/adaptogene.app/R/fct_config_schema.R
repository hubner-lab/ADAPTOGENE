...
config_schema <- function() {
    ...
    list(
        ...
        s("GEA.wza.window_size", "WZA window size",    "gea", "WZA",
          "text",    FALSE,
          help = "Window size for Weighted-Z Analysis. auto_genome_wide (default) uses genome-wide LD r\u00b2=0.2; auto_per_chromosome uses per-chr; or enter a fixed bp value.",
          placeholder = "auto_genome_wide"),
        s("GEA.wza.fallback_window_bp", "WZA fallback window (bp)", "gea", "WZA",
          "numeric", FALSE,
          min = 1000, step = 1000,
          help = "Window size used when LD decay data is unavailable (default: 10000 bp)"),
        # Gene annotation
